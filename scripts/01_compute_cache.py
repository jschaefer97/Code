...
#%%
# ------------------------------------------------------------------------- #
# ------------- Compute the cache for the single indicator UMIDAS models -- #
# ------------------------------------------------------------------------- #
...
run_cache_only = True # <---------------- runs only the cache computation
nowcast_start = pd.Timestamp("2018-03-31") # <----- 4 quarteres before the first nowcast date to get the window
...
# Paramters here are not important since only the cache is computed
# --- Varselect -------------------------------------#
no_lags = "nl_nc" # "nl_nc", "nl_c", "l_c" 
varselection_method = "no_selection" # "pyen" pyentscv pyadal no_selection
alpha = 0.5
