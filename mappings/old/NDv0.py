...
# NDv0.add( # NOTE: This series is also in IfoCast. Keep this turned of to easily compare the two datasets.
#     Series(
...
NDv0.add( # NOTE: Put this to Netexport?
    GroupSeries(
        series_dict={
...
NDv0.add( # NOTE: Maybe put this together with other uncertainty indices?
    GroupSeries(
        series_dict={
...
NDv0.add( # NOTE: Error in the release period. Check if this can be fixed by manually adjusting the series release periods. Would be interesting to see how good this indicator is.
    Series(
        name = "de_pmi_sa_idx",
