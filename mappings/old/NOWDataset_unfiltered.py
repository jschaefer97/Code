...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_bb_fx_ecb_eur_gbp": ("buba_mb_44193", None),
            "de_bb_fx_ecb_eur_jpy": ("buba_mb_44185", None),
            "de_bb_fx_ecb_eur_usd": ("buba_mb_44166", None),
        },
        source_data="mb",
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            ...
            "de_so_manu_dom_comp_elec_eq_ca_sa": ("deprod2943", "pch"),
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_bb_shorttime_seccodeIII_sa": ("buba_mb_118025", None),
            "de_bb_shorttime_seccodeIII_ua": ("buba_mb_66288", None),
        },
        source_data="mb",
        component="Labormarket",
        category="ShortTimeWork",
        subcategory="Social_Security_Code_III"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_comp_agriculture_per_employee_sa": ("denaac2883", None),
            "de_comp_business_per_employee_sa": ("denaac2891", None),
            "de_comp_construction_per_employee_sa": ("denaac2886", None),
            "de_comp_finance_insurance_per_employee_sa": ("denaac2889", None),
            "de_comp_industry_per_employee_sa": ("denaac2884", None),
            "de_comp_info_comm_per_employee_sa": ("denaac2888", None),
            "de_comp_manufacturing_per_employee_sa": ("denaac2885", None),
            "de_comp_other_services_per_employee_sa": ("denaac2893", None),
            "de_comp_public_edu_health_per_employee_sa": ("denaac2892", None),
            "de_comp_real_estate_per_employee_sa": ("denaac2890", None),
            "de_comp_trade_transport_hotels_per_employee_sa": ("denaac2887", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Compensation",
        subcategory="PerEmployee_Sector"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_comp_employees_per_employee_sa": ("denaac1125", None),
            "de_comp_employees_per_employee_monthly_sa": ("deinea0015", None),
            "de_comp_employees_per_hour_sa": ("denaac1126", None),
            "de_comp_employees_total_sa": ("denaac0348", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Compensation",
        subcategory="PerEmployee"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_comp_resident": ("denaac0037", None),
            "de_comp_resident_sa": ("denaac0044", "pch"),
        },
        source_data="mb",
        component="Labormarket",
        category="Compensation",
        subcategory="ResidentConcept"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_disposable_income_contributions_sa": ("denaac0411", "pch"),
            "de_disposable_income_tax_sa": ("denaac0412", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Income",
        subcategory="DisposableIncome_Components"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_employment_agriculture_domestic_sa": ("delama1673", None),
            "de_employment_business_services_domestic_sa": ("delama1705", None),
            "de_employment_construction_domestic_sa": ("delama1685", None),
            "de_employment_finance_insurance_domestic_sa": ("delama1697", None),
            "de_employment_industry_excl_construction_domestic_sa": ("delama1677", None),
            "de_employment_info_comm_domestic_sa": ("delama1693", None),
            "de_employment_manufacturing_domestic_sa": ("delama1681", None),
            "de_employment_other_services_domestic_sa": ("delama1713", None),
            "de_employment_public_edu_health_domestic_sa": ("delama1709", None),
            "de_employment_real_estate_domestic_sa": ("delama1701", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Employment",
        subcategory="BySector_Domestic"
    )
)

NOWDataset.add(
    Series(
        name = "de_employment_employees_total_resident_sa",
        description = "Germany, Employment, Employees, Total, Resident Concept, SA (X13 JDemetra+)",
        category = "Labormarket",
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            ...
            "de_employment_socialsec_agriculture_sa": ("delama0065", None),
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_employment_total_agriculture_sa": ("delama1672", None),
            "de_employment_total_business_services_sa": ("delama1704", None),
            "de_employment_total_construction_sa": ("delama1684", None),
            "de_employment_total_finance_insurance_sa": ("delama1696", None),
            "de_employment_total_industry_excl_construction_sa": ("delama1676", None),
            "de_employment_total_info_comm_sa": ("delama1692", None),
            "de_employment_total_manufacturing_sa": ("delama1680", None),
            "de_employment_total_other_services_sa": ("delama1712", None),
            "de_employment_total_public_edu_health_sa": ("delama1708", None),
            "de_employment_total_realestate_sa": ("delama1700", None),
            "de_employment_total_trade_transport_food_sa": ("delama1688", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Employment",
        subcategory="BySector_Total"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_employment_total_domestic_allpersons_sa": ("delama1717", None),
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_gva_agriculture_sa": ("denaac1322", None),
            "de_gva_business_services_sa": ("denaac1330", None),
            "de_gva_construction_sa": ("denaac1325", None),
            "de_gva_finance_insurance_sa": ("denaac1328", None),
            "de_gva_industry_excl_construction_sa": ("denaac1323", None),
            "de_gva_info_comm_sa": ("denaac1327", None),
            "de_gva_manufacturing_sa": ("denaac1324", None),
            "de_gva_other_services_sa": ("denaac1332", None),
            "de_gva_public_edu_health_sa": ("denaac1331", None),
            "de_gva_real_estate_sa": ("denaac1329", None),
            "de_gva_trade_transport_hotels_sa": ("denaac1326", None),
            "de_gva_total_sa": ("denaac0012", None),
        },
        source_data="mb",
        component="Labormarket",
        category="GrossValueAdded",
        subcategory="BySector"
    )
)

NOWDataset.add(
    Series(
        name = "de_eurostat_selfemp_total_sa",
        description = "Germany, Eurostat, ESA 2010, Basic Breakdowns of Main GDP Aggregates & Employment (By Industry & Assets), Employment A*10 Industry Breakdowns, Total - All NACE Activities, NACE 2.0, Self-Employed - Domestic Concept, Persons, Calendar Adjusted, SA",
        component="Labormarket",
        category="Employment",
        ...
        source = Source(
            data = "mb",
            variable = "thspertotalscaselfdcdee1"
        )
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_hours_worked_per_person_sa": ("delama1422", None),
            "de_hours_worked_per_employee_total_sa": ("delama1434", None),
        },
        source_data="mb",
        component="Labormarket",
        category="HoursWorked",
        subcategory="PerPerson_Employee"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_hours_worked_personsinemp_total_sa": ("delama1718", None),
            "de_hours_worked_personsinemp_agriculture_sa": ("delama1674", None),
            "de_hours_worked_personsinemp_business_sa": ("delama1706", None),
            "de_hours_worked_personsinemp_construction_sa": ("delama1686", None),
            "de_hours_worked_personsinemp_finance_insurance_sa": ("delama1698", None),
            "de_hours_worked_personsinemp_industry_sa": ("delama1678", None),
            "de_hours_worked_personsinemp_info_comm_sa": ("delama1694", None),
            "de_hours_worked_personsinemp_manufacturing_sa": ("delama1682", None),
            "de_hours_worked_personsinemp_other_services_sa": ("delama1714", None),
            "de_hours_worked_personsinemp_public_edu_health_sa": ("delama1710", None),
            "de_hours_worked_personsinemp_real_estate_sa": ("delama1702", None),
            "de_hours_worked_personsinemp_trade_transport_sa": ("delama1690", None),
        },
        source_data="mb",
        component="Labormarket",
        category="HoursWorked",
        subcategory="PersonInEmployment_BySector"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_population_total_sa": ("dedemo0001", None),
            "de_labor_force_total_sa": ("delama0052", None),
            "de_not_in_labor_force_sa": ("delama0051", None),
            "de_selfemp_total_resident_sa": ("delama0899", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Participation",
        subcategory="Population_and_LaborForce"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_prod_per_hour_sa": ("delama1275", None),
            "de_prod_per_person_sa": ("delama1274", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Productivity",
        subcategory="PerHour_and_PerPerson"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_selfemployed_agriculture_sa": ("thsperascaselfdcdee1", None),
            "de_selfemployed_arts_services_extraterritorial_sa": ("thsperr_uscaselfdcdee1", None),
            "de_selfemployed_construction_sa": ("thsperfscaselfdcdee1", None),
            "de_selfemployed_finance_insurance_sa": ("thsperkscaselfdcdee1", None),
            "de_selfemployed_industry_sa": ("thsperb_escaselfdcdee1", None),
            "de_selfemployed_info_comm_sa": ("thsperjscaselfdcdee1", None),
            "de_selfemployed_manufacturing_sa": ("thspercscaselfdcdee1", None),
            "de_selfemployed_public_edu_health_sa": ("thspero_qscaselfdcdee1", None),
            "de_selfemployed_realestate_sa": ("thsperlscaselfdcdee1", None),
            "de_selfemployed_scientific_admin_sa": ("thspermnscaselfdcdee1", None),
            "de_selfemployed_trade_transport_food_sa": ("thsperg_iscaselfdcdee1", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Employment",
        subcategory="SelfEmployed_ByIndustry"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            ...
            "de_unemployment_code_ii_total": ("delama1091", None),
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_shorttime_announcements": ("delama0542", None),
            "de_shorttime_total": ("delama0524", None),
            "de_underemployment_excl_shortwork": ("delama0035", None),
            "de_underemployment_incl_shortwork": ("delama0036", None),
            "de_underemployment_strict_sa": ("delama0034", None),
            "de_tariff_hourly_index": ("deinea0832", "pch"),
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_unit_labor_cost_capita_sa": ("delama1351", None),
            "de_unit_labor_cost_hour_sa": ("delama1352", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Productivity",
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_vacancies_accommodation_food": ("delama0010", None),
            "de_vacancies_agriculture": ("delama0006", None),
            "de_vacancies_construction": ("delama0008", None),
            "de_vacancies_education": ("delama1016", None),
            "de_vacancies_energy": ("delama0992", None),
            "de_vacancies_exterritorial": ("delama1026", None),
            "de_vacancies_finance_insurance": ("delama0011", None),
            "de_vacancies_healthcare_social": ("delama1018", None),
            "de_vacancies_infocomm": ("delama1004", None),
            "de_vacancies_jobs_socialsec": ("delama0900", None),
            # "de_vacancies_manufacturing": ("delama0990", None), # NOTE: This series is also in IfoCast. Keep this turned of to easily compare the two datasets.
            "de_vacancies_mining": ("delama0988", None),
            "de_vacancies_other_econ": ("delama1011", None),
            "de_vacancies_other_services": ("delama1022", None),
            "de_vacancies_private_households": ("delama1024", None),
            "de_vacancies_real_estate": ("delama1007", None),
            "de_vacancies_temp_employment": ("delama0012", None),
            "de_vacancies_trade_motor": ("delama0997", None),
            "de_vacancies_transportation": ("delama0999", None),
            "de_vacancies_water": ("delama0994", None),
        },
        source_data="mb",
        component="Labormarket",
        category="LaborTurnover",
        subcategory="Vacancies_BySector"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_wages_agriculture_per_employee_sa": ("deinea1533", None),
            "de_wages_business_services_per_employee_sa": ("deinea1541", None),
            "de_wages_construction_per_employee_sa": ("deinea1536", None),
            "de_wages_finance_insurance_per_employee_sa": ("deinea1539", None),
            "de_wages_industry_per_employee_sa": ("deinea1534", None),
            "de_wages_info_comm_per_employee_sa": ("deinea1538", None),
            "de_wages_manufacturing_per_employee_sa": ("deinea1535", None),
            "de_wages_other_services_per_employee_sa": ("deinea1543", None),
            "de_wages_public_edu_health_per_employee_sa": ("deinea1542", None),
            "de_wages_real_estate_per_employee_sa": ("deinea1540", None),
            "de_wages_trade_transport_hotels_per_employee_sa": ("deinea1537", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Wages",
        subcategory="Gross_BySector_PerEmployee"
    )
)
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_wages_gross_sa": ("deinea0728", None),
            "de_wages_gross_per_employee_sa": ("deinea0735", None),
            "de_wages_gross_per_hour_sa": ("deinea0736", None),
            "de_wages_gross_monthly_per_employee_sa": ("deinea0016", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Wages",
        subcategory="Gross_Total"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_wages_resident_sa": ("deinea0013", None),
            "de_wages_net_resident_sa": ("deinea0014", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Wages",
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_comp_resident_sa": ("denaac0044", None),
            "de_disposable_income_contributions_sa": ("denaac0411", None),
            "de_disposable_income_tax_sa": ("denaac0412", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Compensation",
        subcategory="Resident_DisposableIncome"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_earnings_nominal_index": ("deinea0790", None),
            "de_earnings_real_index": ("deinea0789", None),
        },
        source_data="mb",
        component="Labormarket",
        category="Earnings",
        subcategory="Index_Total"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_hours_worked_employees_total_sa": ("delama1719", None),
            "de_hours_worked_employees_agriculture_sa": ("delama1675", None),
            "de_hours_worked_employees_business_sa": ("delama1707", None),
            "de_hours_worked_employees_construction_sa": ("delama1687", None),
            "de_hours_worked_employees_finance_insurance_sa": ("delama1699", None),
            "de_hours_worked_employees_industry_sa": ("delama1679", None),
            "de_hours_worked_employees_info_comm_sa": ("delama1695", None),
            "de_hours_worked_employees_manufacturing_sa": ("delama1683", None),
            "de_hours_worked_employees_other_services_sa": ("delama1715", None),
            "de_hours_worked_employees_public_edu_health_sa": ("delama1711", None),
            "de_hours_worked_employees_real_estate_sa": ("delama1703", None),
            "de_hours_worked_employees_trade_transport_sa": ("delama1691", None)
        },
        source_data="mb",
        component="Labormarket",
        category="HoursWorked",
        subcategory="BySector_Domestic_SA"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_vacancies_professional_technical": ("delama1009", None),
            "de_vacancies_public_admin": ("delama1014", None),
            "de_vacancies_socialsec_otherecon": ("delama1012", None),
        },
        source_data="mb",
        component="Labormarket",
        category="LaborTurnover",
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "us_pmi_sa_idx": ("markit_3y_pmiusmanmepm", None),
            "ea_pmi_sa_idx": ("markit_3y_pmiezmanpm", None),
            "cn_pmi_caixin_sa_idx": ("markit_3y_pmicnmanpm", None),
            "world_pmi_jpm_sa_idx": ("markit_3y_pmiglmanpm", None)
        },
        source_data="mb",
        component="Netexport",
        category="SPGlobal",
        subcategory="PMI_Global"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            "de_bb_ft_exports_flow_sa": ("buba_mb_61864", None),
            "de_bb_ft_exports_restworld_eur": ("buba_mb_184941", None),
            "de_bb_ft_imports_restworld_eur": ("buba_mb_184942", None),
        },
        source_data="mb",
        component="Netexport",
        category="ForeignTrade",
        subcategory="RestofWorld"
    )
)
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            ...
            "de_hde_willingness_buy_index": ("desurv01064", None),
...
NOWDataset.add(
    Series(
        name = "de_final_consumption_index",
        description = "Germany, Expenditure Approach, Final Consumption Expenditure, Households & NPISH, Total, Calendar Adjusted (X13 JDemetra+), Constant Prices, SA (X13 JDemetra+), Chained, Index",
        component="Privconsumption",
        category="FinalConsumption",
        transformation = "",
        source = Source(
            data = "mb",
            variable = "denaac0162"
...
NOWDataset.add(
    GroupSeries(
        series_dict={
            ...
            "ifocast_to_manu": ("delama0990", None),
            ...
            "ifocast_ip_tot_world": ("worldiptotsakdgemmonth", None),
