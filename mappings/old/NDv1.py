...
# NDv1.add( # NOTE: This series is also in IfoCast. Keep this turned of to easily compare the two datasets.
#     Series(
...
NDv1.add(
    GroupSeries(
        series_dict={
            ...
            # "de_ifo_bs_motorcv_financing_bottle_yn": ("deifo_c2911000_fej_bdu", None), # NOTE: Difference to the NDv0
...
NDv1.add( # NOTE: Put this to Netexport?
    GroupSeries(
        series_dict={
...
NDv1.add( # NOTE: Maybe put this together with other uncertainty indices?
    GroupSeries(
        series_dict={
...
NDv1.add( # NOTE: Error in the release period. Check if this can be fixed by manually adjusting the series release periods. Would be interesting to see how good this indicator is.
    Series(
        name = "de_pmi_sa_idx",
...
NDv1.add(
    GroupSeries(
        series_dict={
            "ifocast_ip_tot": ("deprod1404", "chg"),
            "ifocast_to_energy": ("detrad3364", "chg"),
            "ifocast_to_retail": ("detrad1360", "chg"),
            "ifocast_to_hosp": ("detrad3877", "chg"),
            "ifocast_to_wholesale": ("detrad8150", "chg"),
            "ifocast_no_tot_manu": ("deprod2112", "chg"),
            "ifocast_no_dom_manu": ("deprod2113", "chg"),
            ...
            "ifocast_imp_tot": ("detrad0689", "chg"),
            "ifocast_exp_tot": ("detrad0692", "chg"),
            "ifocast_trade_world": ("worldtrad0001", "chg"),
            "ifocast_inflation": ("depric1962", "chg")
        },
        source_data="mb",
        component="IfoCast",
    )
